/**
 * `manni tracevals calibrate` (ADR 01022).
 *
...
import { runCalibrate } from "../../../src/tracevals/commands/calibrate.js";
...
let tmpDir: string;
beforeAll(async () => {
  tmpDir = await mkdtemp(join(tmpdir(), "manni-tracevals-calibrate-"));
});
afterAll(async () => {
