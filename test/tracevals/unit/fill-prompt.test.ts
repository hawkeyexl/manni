...
import {
  ...
  isValidProposal,
  systemPromptFor,
} from "../../../src/tracevals/fill/prompt.js";
import { FillCache, fillCacheKey } from "../../../src/tracevals/fill/cache.js";
...
describe("fill cache", () => {
  ...
  beforeAll(async () => {
    dir = await mkdtemp(join(tmpdir(), "manni-tracevals-fill-cache-"));
  });
  afterAll(async () => {
