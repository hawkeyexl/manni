 ...
 * config moves one, so the floor is the only lever this domain's shape allows. Proposal 0048 records why, and supersedes the one
 * paragraph of 0035 that described the two as separable.
 */
