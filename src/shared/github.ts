/**
 * GitHub Actions workflow-command primitives, shared by every renderer in
 * every tool that emits `::error ...::<message>`.
 *
 ...
 * is easy to miss. Under `src/shared/` because the a11y reporter needs the
 * same two functions, and one tool must not reach into another's internals.
 */
