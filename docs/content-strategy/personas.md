...
**Which tools she owns work in.** She owns work in meta and key, and in the citation standard, so the required field, its encrypted value and its citations are hers.
