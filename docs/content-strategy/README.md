...
2. **Find the matching CUJ in `cujs.md`.** Each persona has a numbered series of journeys across the tools (M1–M17, D1–D11, S1–S11, T1–T5). Understand the end-to-end outcome the persona needs to reach.
