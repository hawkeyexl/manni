...
| Citations reference (`cite/reference/citations.mdx`) | `docs/proposals/0040/schemas/citations/1.0.0-proposal.1.json` (the entry shape, `src` grammar, hashing rule), `src/cite/core/statements.ts` (the inline forms and anchors) |
