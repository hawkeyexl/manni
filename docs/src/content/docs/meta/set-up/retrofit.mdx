...
audiences:
  - docs-engineers
  - ci-engineers
intent: Adopt manni meta on an existing documentation repository without breaking the build on day one
visibility: public
lifecycle: published
prerequisites:
  ...
  - ci-cd-concepts
next-steps:
  - /manni/meta/set-up/config/
  - /manni/meta/schemas/
related-pages:
  - /manni/meta/set-up/config/
  - /manni/meta/schemas/
  - /manni/meta/set-up/fill-providers/
sample-questions:
  - How do I add manni meta to an existing docs repo?
  - How do I avoid breaking the build when adding metadata validation?
  - How do I adopt metadata validation incrementally?
meta-provenance:
...
{/* cite infer-counts-metadata-keys */}
{/* cite infer-is-offline */}
...
{/* cite infer-reports-files-without-metadata */}
...
{/* cite infer-out-writes-the-draft-schema */}
...
{/* cite infer-draft-has-empty-required */}
...
{/* cite infer-draft-constrains-only-observed-fields */}
...
{/* cite infer-out-refuses-a-gitignored-path */}
...
{/* cite validate-exit-zero-pass-one-fail */}
...
{/* cite github-format-emits-workflow-annotations */}
...
{/* cite collections-supply-inputs-for-a-bare-run */}
...
{/* cite overrides-assign-schema-set-per-area */}
...
{/* cite override-may-select-by-files-glob */}
...
{/* cite baseline-fails-only-on-new-findings */}
{/* cite write-baseline-reports-added-and-removed */}
...
{/* cite baseline-config-key-enables-comparison */}
...
{/* cite baseline-debt-printed-on-every-run */}
...
{/* cite fill-uses-validate-schema-resolution */}
{/* cite fill-candidates-are-missing-or-invalid */}
{/* cite fill-candidates-come-from-schema-properties */}
...
{/* cite fill-summary-names-provider-threshold-counts */}
{/* cite fill-default-confidence-threshold-is-0-7 */}
...
{/* cite fill-records-meta-provenance-entry */}
...
{/* cite confidence-gate-skips-below-threshold */}
{/* cite low-confidence-fields-listed-with-scores */}
{/* cite confidence-flag-sets-write-threshold */}
...
{/* cite cache-stores-pre-gate-proposals */}
