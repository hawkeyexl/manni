---
title: "manni:kg:1.0.0-proposal.3"
...
[`docs/proposals/0023/schemas/kg/1.0.0-proposal.3.json`](https://github.com/hawkeyexl/manni/blob/main/docs/proposals/0023/schemas/kg/1.0.0-proposal.3.json).
:::
...
`/kg/sections`, `/kg/revision-of` or `/kg/derived-from` to a model: those three
are curated by hand.
