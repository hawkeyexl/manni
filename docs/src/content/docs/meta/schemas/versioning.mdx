...
audiences:
  ...
  - CI engineers
intent: Version and evolve JSON Schema safely without breaking CI across repositories
visibility: public
lifecycle: published
...
concepts:
  - schema
  - dialect
prerequisites: Understanding of JSON Schema basics
next-steps:
...
sample-questions:
  ...
  - What JSON Schema dialects does manni meta support?
  - How do I make breaking changes to a schema safely?
  - How do I add a required field without breaking CI?
meta-provenance:
...
{/* cite builtin-versions-are-decided-by-manni */}
...
{/* cite alter-table-edits-the-resolved-schema */}
...
{/* cite declared-type-maps-to-a-format */}
...
{/* cite default-rejected-by-the-mapped-format */}
...
{/* cite builtin-forks-to-a-local-copy */}
...
{/* cite versioning-dialect-read-from-schema-line */}
...
{/* cite each-schema-compiles-in-its-own-engine */}
