...
audiences:
  - developers
  - programmers
intent: understand and use the manni meta TypeScript API programmatically
visibility: public
lifecycle: published
...
prerequisites:
  ...
  - Node.js familiarity
  - understanding of manni meta basics
related-pages:
  - /manni/meta/ci/consume-results/
risks: read-only
sample-questions:
  - What exports does the manni meta API provide?
  - How do I validate metadata programmatically?
  - What is the difference between extractors and reporters?
  - How do I work with collections in the API?
meta-provenance:
