...
| `isBuiltinField` | Type guard for a user-supplied field name: whether it is one of the six built-ins. |
| `isDerivableField` | The same guard under its earlier name, kept for API stability. |
