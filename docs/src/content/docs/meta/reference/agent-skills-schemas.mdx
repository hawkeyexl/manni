...
audiences:
  - skill-authors
  - developers
intent: understand the two Agent Skills schemas and determine which to use for validation
concepts:
  - schema
  - validation
  - frontmatter
...
risks: read-only
sample-questions:
  - Which schema should I use for my SKILL.md file?
  - What's the difference between agentskills:skill:1.0 and anthropic:claude-skill:2.1?
  - Why does one schema reject unknown keys?
  - How do I validate a skill before publishing?
graph:
  type: reference
  concepts:
    - schema
...
{/* cite skills-claude-schema-is-a-superset */}
...
{/* cite skills-only-builtin-with-additionalproperties-false */}
...
{/* cite skills-strictness-mirrors-the-upload */}
...
{/* cite skills-metadata-takes-strings-only */}
...
{/* cite skills-name-must-match-the-directory */}
...
{/* cite skills-claude-schema-requires-nothing */}
...
{/* cite skills-effort-context-and-shell-are-enumerated */}
...
{/* cite skills-model-is-not-enumerated */}
...
{/* cite skills-claude-name-is-unconstrained */}
...
{/* cite skills-six-boolean-spellings */}
...
{/* cite skills-flag-accepts-three-types */}
...
{/* cite skills-each-failure-is-attributed */}
...
{/* cite skills-stacking-reports-claude-only-keys */}
...
{/* cite skills-subagent-is-a-different-contract */}
