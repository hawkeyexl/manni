...
language: en
source-of-truth:
  - path: src/meta/reporters/index.ts
    kind: source
  - path: src/shared/severity.ts
    kind: source
  - path: src/shared/run.ts
    kind: source
audiences:
  - developers
  - ci-engineers
intent: Understand how to interpret manni meta validate output formats and exit codes
visibility: public
lifecycle: published
applies-to: meta
concepts:
...
risks: read-only
sample-questions:
  - What output formats does manni meta validate support?
  - What do the exit codes mean?
  - How do I use SARIF format in GitHub Actions?
graph:
  type: reference
meta-provenance:
