...
| `manni lint check` | `error` only | Every structural finding is an error, and there is no severity map. [Exit `1`](/manni/lint/reference/cli/#exit-codes) is defined on severity rather than on "any finding". |
