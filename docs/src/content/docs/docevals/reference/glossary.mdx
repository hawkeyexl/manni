---
title: Glossary
description: The terms that recur across every section of these docs.
---
...
: 20–50 human-verified cases in `.manni/docevals/golden/*.yaml` that
  [calibration](/manni/docevals/judge/calibrate/) scores the judge against. This is the artifact you hand a
  skeptic.

**Grader**
: What decides an eval. `command` and `tool:*` are code, `ai` is the judge, `human` is a person.
  They sit in that preference order. See [Graders](/manni/docevals/reference/graders/).
