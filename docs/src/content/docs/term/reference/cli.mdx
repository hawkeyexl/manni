...
audiences:
  ...
  - CI engineers
intent: look up the syntax, arguments, flags, and exit codes for manni term commands
visibility: public
lifecycle: published
applies-to: manni term
prerequisites:
  - term/get-started/index.mdx
related-pages:
  - term/reference/configuration.mdx
  - term/reference/terminology.mdx
  - term/reference/rules.mdx
risks: read-only
sample-questions:
  - How do I list all terms in my glossary?
  - What commands does manni term provide?
  - How do I check term references in my documentation?
  - How do I run Vale over term definitions?
  - What output formats does manni term support?
meta-provenance:
...
- **Every file contributes references.** A page's `concepts:` and its
  `graph.concepts` are read whether or not the page holds a term.
