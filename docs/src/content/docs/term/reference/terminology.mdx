...
keywords:
  ...
  - validation
language: en
intent: Understand the structure, fields, and validation rules for term entries in the manni terminology system
visibility: public
lifecycle: published
concepts:
  - metadata
...
risks: read-only
sample-questions:
  - What fields does a term entry have?
  - What is the difference between label, alt-labels, and hidden-labels?
  - How do I mark a file as containing terminology entries?
  - What SKOS mappings do the terminology fields use?
  - How does the see redirect work in term entries?
meta-provenance:
