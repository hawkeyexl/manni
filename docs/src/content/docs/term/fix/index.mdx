...
audiences:
  ...
  - technical writers
intent: Fix a failing term check in a pull request
concepts:
  - validation
prerequisites:
  - Understanding of git and pull requests
  - Familiarity with YAML frontmatter
  - Basic knowledge of CI workflows
related-pages:
...
risks: read-only
sample-questions:
  - How do I fix a failing term check?
  - What does this term annotation mean?
  - How do I resolve undefined-term errors?
  - Why is my pull request's term check red?
meta-provenance:
