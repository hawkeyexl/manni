...
audiences:
  ...
  - technical writers
intent: Set up Vale to validate terminology usage and generate a Vale style from the term set
visibility: public
lifecycle: published
prerequisites:
  - term/get-started
related-pages:
  ...
  - term/reference/cli
sample-questions:
  - How do I integrate my terminology with Vale?
  - How do I validate term usage with Vale?
  - How do I generate a Vale style from my term set?
meta-provenance:
