...
keywords:
  ...
  - manni key
language: en
intent: Set and rotate the family encryption key used to encrypt metadata values across all manni tools
related-pages:
...
`manni key` is in beta. Its commands, config keys and output can change in
