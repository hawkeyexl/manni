...
mean paragraphs, code blocks, lists, tables, admonitions, images, block quotes,
definition lists, or a named component.
...
This is that package, folded into the manni bin and given a family surface. The
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="From one page you are happy with to a doctype shape the whole repository is held to. Infer it, loosen it, route it."
  />
  <LinkCard
  ...
  <LinkCard
    ...
    description="The template grammar, every rule and block key, the kind matrix, how sections are matched, and types: routing."
  />
</CardGrid>
