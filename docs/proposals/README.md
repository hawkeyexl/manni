...
| [0049](0049-lint-domain.md) | The `lint` domain: `manni lint check` runs every configured job and `manni lint structure` checks a page against its doctype template. Verbs name the job, config names the tool behind it | Maya · M14 / Devin · D10 / Theo · T5 | Proposed |
...
| Tool | Log | Records |
|---|---|---|
| lint | [lint/](lint/README.md) | 01001–01008, imported with the tool. 01007 is superseded by [0049](0049-lint-domain.md) |
