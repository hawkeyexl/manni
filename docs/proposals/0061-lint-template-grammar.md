...
- **Serves:** Three journeys.
  ...
  - Theo · T5, "Read a structure failure and fix it". One wrong heading should
    read as one finding.
- **Depends on:** Three.
  - [0065](0065-content-model.md) names the content kinds. A template asks
...
A parser declares which kinds it emits (0065). A rule about a kind this file's
...
It is not a section. That follows from 0065, where an element's children are
