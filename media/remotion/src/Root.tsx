...
import { beats as vocabBeats, totalFrames as vocabTotalFrames, TYPING_MS as vocabTypingMs } from "./vocabularies/beats";
...
/**
 * manni-vocabularies-1x1: 23 px / 75 columns, derived in media/vocabularies/manni-vocabularies-1x1.script.md
 * (media/vocabularies/capture/cols.mjs). Ligatures off: the frontmatter fences are `---`.
 */
const DemoVocab: React.FC = () => <DemoView beats={vocabBeats} fontPx={23} linePx={32} cols={75} typingMs={vocabTypingMs} ligatures={false} />;
...
export const Root: React.FC = () => (
  <>
    ...
    <Composition
      ...
      height={1080}
      fps={FPS}
      durationInFrames={vocabTotalFrames}
    />
  </>
);
