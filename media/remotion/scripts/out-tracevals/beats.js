...
// ---- Timeline ---------------------------------------------------------------
const typingFrames = (typed, typingMs = exports.TYPING_MS) => Math.ceil((typed.length * typingMs * exports.FPS) / 1000);
exports.typingFrames = typingFrames;
function timeline(beat, typingMs = exports.TYPING_MS) {
    let t = beat.continues ? 4 : exports.IDLE_START_FRAMES;
    const commands = beat.commands.map((c) => {
        const typeStart = t;
        const enterAt = typeStart + (0, exports.typingFrames)(c.typed, typingMs) + exports.ENTER_PAUSE_FRAMES;
